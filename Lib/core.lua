...
function VLib:Window(textgame)
	...
	coroutine.wrap(
		function()
			while wait() do
				RainbowLine.BackgroundColor3 = Color3.fromRGB(66,69,73)
				Circle.BackgroundColor3 = Color3.fromRGB(66,69,73)
			end
		end
	)()
	local Tabs = {}
	function Tabs:Tab(text)
		...
		coroutine.wrap(
			function()
				while wait() do
					Tab.BackgroundColor3 = Color3.fromRGB(66,69,73)
				end
			end
		)()
		...
		function ContainerItems:Colorpicker(text, preset, callback)
			...
			coroutine.wrap(
				function()
					while wait() do
						RainbowToggleFrameRainbow.BackgroundColor3 = Color3.fromHSV(66,69,73)
					end
				end
			)()
		end
